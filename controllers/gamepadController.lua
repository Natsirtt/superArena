...
buttonsMap["Linux"][buttons.A] = 0
buttonsMap["Linux"][buttons.B] = 1
buttonsMap["Linux"][buttons.X] = 2
buttonsMap["Linux"][buttons.Y] = 3
buttonsMap["Linux"][buttons.JOYSTICK_LEFT] = 9
buttonsMap["Linux"][buttons.JOYSTICK_RIGHT] = 10
buttonsMap["Linux"][buttons.UP] = 13
buttonsMap["Linux"][buttons.DOWN] = 14
buttonsMap["Linux"][buttons.LEFT] = 12
buttonsMap["Linux"][buttons.RIGHT] = 11
buttonsMap["Linux"][buttons.START] = 7
buttonsMap["Linux"][buttons.SELECT] = 6
buttonsMap["Linux"][buttons.LB] = 4
buttonsMap["Linux"][buttons.RB] = 5
